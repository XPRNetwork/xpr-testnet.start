...
> **_NOTE:_**  XPR Network Consortium is requesting all Block Producers to update their nodes to the latest version of Leap (4.0.4) by 30 October 2023. This update is required to ensure the stability of the XPR Network TestNet.
...
# 4. Restore/Start from Snapshots
   ...
   wget [http://backup.cryptolions.io/ProtonTestNet/snapshots/latest-snapshot.bin.zst](https://backup.cryptolions.io/ProtonTestNet/snapshots/latest-snapshot.bin.zst)
   ```
